package com.example.project12170;
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isEmpty(cekNama) || isEmpty(cekJenis) || isEmpty(cekKondisi) || isEmpty(cekHrgbeli) || isEmpty(cekHrgjual)){
                    ...
                    setBarang.setJenis(jenisBaru.getText().toString());
                    setBarang.setKondisi(kondisiBaru.getText().toString());
                    setBarang.setHrg_beli(hrgbeliBaru.getText().toString());
                    setBarang.setHrg_jual(hrgjualBaru.getText().toString());
